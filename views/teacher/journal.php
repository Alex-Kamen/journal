...
<body>
				...
				<div class="container">
					<div class="journal__inner">
						<div class="select__title">
							<h1 class="content__title">Журнал за: </h1>
							<select name="year">
								<option selected disabled value="none">Учебный год - семестр</option>
						...
						<form action="#">
							<div class="select">
								...
								<select name="group">
									<option selected disabled value="none">Группа</option>
									<?php foreach ($groupList as $groupItem): ?>
										<option value="<?php echo $groupItem['id']; ?>">
							...
							<div class="select">
								...
								<select name="chair">
									<option selected disabled value="none">Кафедра</option>
									<?php foreach ($chairList as $chairId => $chairName): ?>
										<option value="<?php echo $chairId; ?>">
											<?php echo $chairName; ?>
										</option>
									<?php endforeach; ?>
								</select>
	...
	<script type="text/javascript" src="../../static/script/AJAX/journal.js?<?php echo time();?>"></script>
</body>
</html>