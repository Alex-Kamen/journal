...
<body>
				...
				<div class="container">
					<div class="progress__inner">
						<div class="select__title">
							<h1 class="content__title">Рапортичка группы за: </h1>
							<select name="month">
								<option selected disabled>Месяц</option>
									<?php foreach($monthList as $monthId => $monthName): ?>
	...
	<script type="text/javascript" src="../../static/script/AJAX/report_teacher.js?<?php echo time();?>"></script>
